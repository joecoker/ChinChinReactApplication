  ...
  render() {
    ...
    return (
      <div className='cocktail-item card'><Link to={address}>
        <div class="image-container"><img class='thumbnail' src={"https://s3.eu-west-2.amazonaws.com/chinchinreact/thumbnails/" + this.props.cocktail.pictureUrl } alt={this.props.cocktail.name} /></div>
